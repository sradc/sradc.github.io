...
date_edited: 2023-07-06 00:00:00 +0000
categories:
comments: true
---

*a walkthrough of BPE, with a worked example and a couple of Python implementations*
...
- Start off with initial set of tokens (e.g. single characters for this example, but we could treat the text as a stream of bytes and use single bytes instead).
