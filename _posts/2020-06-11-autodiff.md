...
Note the distinction between local derivatives and partial derivatives: a partial derivative takes the whole graph into account, whereas a local derivative doesn't.
...
def get_gradients(variable):
    ...
    which contains references to a variable's
    child variables.
    I.e.    
