...
The small autodiff framework will deal with scalars. We will later use NumPy to vectorise it. And then briefly look at how to compute Nth order derivatives.
...
**The following two additional sections cover vectorisation and Nth derivatives.**
...
```python
# If we really wanted higher order derivatives,
